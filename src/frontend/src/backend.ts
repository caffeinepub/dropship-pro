...
import type { CustomOrder as _CustomOrder, OrderStatus as _OrderStatus, Time as _Time } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async addProduct(arg0: string, arg1: string, arg2: bigint, arg3: number, arg4: number): Promise<bigint> {
    ...
    async calculateProductProfit(arg0: bigint): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.calculateProductProfit(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createOrder(arg0: bigint, arg1: bigint, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAllOrdersSortedByTimestamp(): Promise<Array<CustomOrder>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllOrdersSortedByTimestamp();
    ...
    async getOrder(arg0: bigint): Promise<CustomOrder> {
        if (this.processError) {
            try {
                const result = await this.actor.getOrder(arg0);
                return from_candid_CustomOrder_n2(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getSupplierProducts(arg0: bigint): Promise<Array<Product>> {
        if (this.processError) {
            try {
...
function from_candid_CustomOrder_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CustomOrder): CustomOrder {
...
function from_candid_vec_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CustomOrder>): Array<CustomOrder> {
    return value.map((x)=>from_candid_CustomOrder_n2(_uploadFile, _downloadFile, x));
}
